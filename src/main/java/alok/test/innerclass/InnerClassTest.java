...
class InnerClassTest {
	...
	public static void main(String args[]) {
		...
		InnerClassTest maiN = new InnerClassTest();
		Object obj = maiN.new MainInnerClass(10);
		System.out.println("Main.MainInnerClass.i: " + ((InnerClassTest.MainInnerClass)obj).i);
